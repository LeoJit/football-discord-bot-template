# Generated by Django 2.2.3 on 2021-03-20 13:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cog', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prediction_db.Cog', verbose_name='Cog this command belongs to')),
            ],
        ),
        migrations.CreateModel(
            name='DBGuild',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('g', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prediction_db.DBGuild', verbose_name='Associated server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('g_admin', models.BooleanField(default=False, verbose_name='Admin flag, set by Admin')),
                ('g_mod', models.BooleanField(default=False, verbose_name='Mod flag, set by Admin')),
                ('g', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prediction_db.DBGuild', verbose_name='Associated server')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('u', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='prediction_db.DBUser', verbose_name='User that was added to the bot')),
            ],
        ),
        migrations.CreateModel(
            name='Predictions',
            fields=[
                ...
                ('u', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='prediction_db.DBUser', verbose_name='User who predicted')),
            ],
        ),
        migrations.CreateModel(
            name='GuildStats',
            fields=[
                ...
                ('g_joined', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='guildstats_guild_join', to='prediction_db.DBGuild', verbose_name='Guild that joined the server to their community')),
                ('g_left', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='guildstats_guild_leave', to='prediction_db.DBGuild', verbose_name='Guild that removed the bot from their server')),
                ('related_object', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='prediction_db.GuildStats', verbose_name='Related object (i.e. when they joined it)')),
            ],
        ),
        migrations.CreateModel(
            name='Error',
            fields=[
                ...
                ('g', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prediction_db.DBGuild', verbose_name='Guild where error happened')),
            ],
        ),
        migrations.CreateModel(
            name='CommandStats',
            fields=[
                ...
                ('command', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prediction_db.Command', verbose_name='Command that was executed')),
                ('g', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='prediction_db.DBGuild', verbose_name='Guild that used the command')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prediction_db.DBUser', verbose_name='User that executed this command')),
            ],
        ),
        migrations.CreateModel(
            name='ModRole',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('g', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prediction_db.DBGuild', verbose_name='Guild associated to this mod')),
                ('role', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prediction_db.DBRole', verbose_name='Role that makes user mods')),
            ],
            options={
